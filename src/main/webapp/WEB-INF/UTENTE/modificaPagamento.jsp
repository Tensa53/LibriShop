...
<div id="container-forms" class="center">
    <form method="post" name="modifica-pagamento">
        ...
        <input type="number" value="<%=pagamento.getNumeroCarta()%>" name="numeroCarta" id="numeroCarta" min="1" step="1" required><br>
        ...
        <input type="number" value="<%=pagamento.getCCV()%>" name="ccv" id="ccv" min="1" step="1" required><br><br>
